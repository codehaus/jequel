...
public class HsqlStatementNamedExplicitParameterTest extends AbstractStatementTest {
    protected void setUp() throws Exception {
        dataSource = GeneratorTestUtils.createAndSetupHsqlDatasource();
        executableStatement = getArticleSql().executeOn(dataSource).withParams("article_oid", 10);
    }
    ...
    public SqlWrapper getArticleSql() {
        ...
        sql.where().and(ARTICLE.OID.eq(Expressions.named("article_oid")));
        return sql;
    }
